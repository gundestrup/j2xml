...
namespace Joomla\Component\J2xml\Administrator\View\Viewlevels;

\defined('_JEXEC') or die;

use Joomla\Component\J2xml\Administrator\View\AbstractRawView;

/**
 * viewlevels raw export view.
 */
class RawView extends AbstractRawView
{
    protected string $exportMethod = 'viewlevels';
}
