# AI_INSTRUCTIONS — J2XML

> **Single source of truth for AI coding assistants working on this repository.**
>
> This file is referenced by `AGENTS.md`, `CLAUDE.md`, `.windsurfrules`, and
> `.devin/global_rules.md`. **Do not duplicate project guidance** — edit this
> file and the pointer files will continue to redirect here.
...
└── .windsurfrules              # Pointer → AI_INSTRUCTIONS.md (Windsurf)
```
...
here. **Keep them as pointers**; edit `AI_INSTRUCTIONS.md` for any content
change.

| File               | Read by                                      | Contents                          |
|--------------------|----------------------------------------------|-----------------------------------|
| `AGENTS.md`        | Devin CLI, generic agent tools               | `See AI_INSTRUCTIONS.md.`         |
| `CLAUDE.md`        | Claude Code                                  | `See AI_INSTRUCTIONS.md.`         |
| `.windsurfrules`   | Windsurf                                     | `See AI_INSTRUCTIONS.md.`         |
| `.devin/global_rules.md` | Devin CLI (`.devin/` rules)            | `See AI_INSTRUCTIONS.md.`         |

If you add support for another AI tool, add a one-line pointer file here and
keep the actual guidance in `AI_INSTRUCTIONS.md`.
